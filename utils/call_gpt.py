...
def call_gpt(prompt, 
    ...
    if api_key==None:
        if model in ['gpt-4o-2024-05-13', 'gpt-4o-mini-2024-07-18']:
            api_key='sk-gCsUau0Dt5aIwPbo3dFe043c57984383B3Ee58C6277c65Bc'
        else:
            api_key='ollama'
    
    if base_url==None:
        if model in ['gpt-4o-2024-05-13', 'gpt-4o-mini-2024-07-18']:
            base_url="https://api.xhrai.com/v1"
        else:
...
async def call_gpt_async(prompt, 
    ...
    # API 配置
    if api_key is None:
        api_key = 'sk-gCsUau0Dt5aIwPbo3dFe043c57984383B3Ee58C6277c65Bc' if model in ['gpt-4o-2024-05-13', 'gpt-4o-mini-2024-07-18'] else 'ollama'
    
    if base_url is None:
        base_url = "https://api.xhrai.com/v1" if model in ['gpt-4o-2024-05-13', 'gpt-4o-mini-2024-07-18'] else "http://10.4.182.51:11434/v1/"
